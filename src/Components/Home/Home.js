...
const Home = () => {
    ...
    return (
        <div>
            <h1 className='ml-52 mr-52 mt-10 mb-10 text-orange-400 bolder text-3xl'>Welcome to our front-end web developer learning pathway!</h1>
            <h1 className='ml-52 mr-52 mt-14 mb-14 text-2xl'>Here we provide you with a structured course that will teach you all you need to know to become a front-end web developer.
            ...
            <div className='ml-52 mr-52 grid grid-cols-2 gap-4'>
            {
